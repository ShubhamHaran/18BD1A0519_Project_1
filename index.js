...
app.get('/hospitaldetails/gethosbyname',middleware.checkToken,function(req,res){
...
app.get('/ventilatordetails/getventbystatus',middleware.checkToken,function(req,res){
...
app.get('/ventilatordetails/getventbyname',middleware.checkToken,function(req,res){
